...
const App = () => {
  ...
  const [mintedNFT, setMintedNFT] = useState({success: false, link: ''})
  ...
  const setupEventListener = async () => {
    ...
    try {
      const { ethereum } = window;
      setMintedNFT({success: false, link: ''})
      ...
      if (ethereum) {
        ...
        let currentNFTsNumber = await connectedContract.getTotalNFTsMintedSoFar();
        setCurrentMinted(currentNFTsNumber.toNumber())
        ...
        connectedContract.on("NewEpicNFTMinted", (from, tokenId) => {
          ...
          setCurrentMinted(currentNFTsNumber.toNumber() + 1)
  ...
  const renderMintUI = () => (
    <button onClick={askContractToMintNft} className="cta-button connect-wallet-button">
      {isMining ? <span><i className="fa fa-circle-o-notch fa-spin"></i>Mining</span> : 'Mint NFT'}
    </button>
  )
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">NFT terminology Collection</p>
        ...
        <div className="footer-container">
          ...
          <div className="footer-link-item">
            <img alt="Opensea Logo" className="twitter-logo" src="https://storage.googleapis.com/opensea-static/Logomark/Logomark-Blue.svg" />
            <a
              className="footer-text"
              href={OPENSEA_LINK}
              target="_blank"
